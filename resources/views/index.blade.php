    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card sc">
                    <span class="infos">120 <i class="ion-ios-basket"></i></span>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card sc">
                    <span class="infos">50 <i class="ion-ios-list-box"></i></span>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card bg">
                    <span class="infos"><font color="#c30">25</font> <i class="ion-ios-trending-down"></i></span>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card bg">
                    <span class="infos"><font color="#f90">83</font> <i class="ion-ios-checkbox"></i></span>
